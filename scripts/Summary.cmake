...
function(print_target_config TARGET INDENT)
    ...
    if (${T_TYPE} STREQUAL "UTILITY" OR ${T_TYPE} STREQUAL "GLOBAL_TARGET")
        return()
    endif()
    ...
    foreach (_P ${XCMAKE_TGT_PROPERTIES})
        ...
        if (NOT ${PROP_VAL} STREQUAL "${XCMAKE_${_P}}" AND NOT ${PROP_VAL} STREQUAL "PROP_VAL-NOTFOUND")
...
function(print_compiler)
    ...
    execute_process(COMMAND "${CMAKE_CXX_COMPILER_LINKER}" "--version" OUTPUT_VARIABLE LINKER_VERSION ERROR_QUIET OUTPUT_QUIET)
    ...
    message(CYAN "Linker: ${BOLD}${CMAKE_CXX_COMPILER_LINKER}${BOLD_OFF}")
