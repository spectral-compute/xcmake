...
function(xcmake_log_buffer_append)
    get_property(BUF GLOBAL PROPERTY xcmake_log_buffer)
    if ("${BUF}")
        set_property(GLOBAL APPEND PROPERTY xcmake_log_buffer ";")
    endif()
...
function(xcmake_log_buffer_dump)
    message(BOLD_RED "\n                        ERROR RAISED")
    message(BOLD_YELLOW "        *** PRINTING LAST CONFIGURE LOG ITEM ***\n")
    get_property(FULL_LOG GLOBAL PROPERTY xcmake_log_buffer)
    list(POP_BACK FULL_LOG LOG)
    if (LOG)
        _message("${LOG}\n")
    else()
        message(BOLD_RED " configure log is empty, no further info, apologies ")
    endif()
...
# ```
#
# The last item of the configure log is dumped to the screen on FATAL_ERROR.
#
